// describe('amazon',()=>{
//     it('hellow kitti bag product count',()=>{
//         cy.visit('https://www.amazon.in/')
//         cy.get('[type="text"]').type('hello')
//             cy.wait(4000)
//         cy.get('[id="nav-flyout-searchAjax"]>div').last()
//       //cy.get('[class="s-suggestion-container"]').eq(0).click()
//         .each((el,index)=>{
//             let text = el.text()
//             cy.log(text)
//             if(text == 'hello kitty bag' ){
//                 cy.wrap(text).eq(index).click({force:true})
//             }
//         })
